...
All 28 issued packets were terminal before hidden gold was loaded. Model telemetry unavailable: selector `hosted-default`; CLI `codex-cli-0.146.0-alpha.3.1`. Reason: Codex JSONL did not report the resolved model; retained runner selection was hosted-default. Retained usage was 559,386 input, 23,444 output, and 60,160 cached-input tokens across 28 attempts, with 702.690 aggregate seconds. No new provider or model calls were made by this finalizer.
