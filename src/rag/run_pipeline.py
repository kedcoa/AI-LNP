...
def run(paper_ids: list[str]) -> dict:
    ...
    (PACKETS / "manifest.json").write_text(json.dumps(summary, indent=2) + "\n")
    return summary
...
if __name__ == "__main__":
    ...
    print(json.dumps(run(selected), indent=2))
